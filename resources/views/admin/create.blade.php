                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" value="{{ old('alamat') }}"  rows="5" placeholder="Masukkan Alamat"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select @error('jenis_kelamin') is-invalid @enderror" aria-label="Disabled select example" name="jenis_kelamin" value="{{ old('jenis_kelamin') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('masuk_kerja') is-invalid @enderror" name="masuk_kerja" value="{{ old('masuk_kerja') }}" placeholder="Masuk Kerja">
                            ...
                            <a href="{{ url('admin/dashboard') }}" class="btn btn-danger">KEMBALI</a>
